...
/**
 *  Implementation of the OpeEXTEfx.nal extension ALC_EXT_EFX (version 1.0). Contains necessary fields,
 ...
 *  which is part of the OpeEXTEfx.nal SDK and can be downloaded from:
 *  http://connect.creativelabs.com/opeEXTEfx.nal/Downloads/Forms/AllItems.aspx
 * <p>
...
public class EFX10 {
	...
	public static java.lang.String ALC_EXT_EFX_NAME = "ALC_EXT_EFX";

	public static int ALC_EFX_MAJOR_VERSION = 0x20001,
	...
	public static float AL_MIN_AIR_ABSORPTION_FACTOR = 0.0f,
	...
	public static int AL_MIN_DIRECT_FILTER_GAINHF_AUTO = 0x0,
	...
	public static float AL_MIN_METERS_PER_UNIT = 1.4E-45f,
	...
	public static int AL_REVERB_MIN_DECAY_HFLIMIT = 0x0,
					  AL_REVERB_MAX_DECAY_HFLIMIT = 0x1,
					  AL_REVERB_DEFAULT_DECAY_HFLIMIT = 0x1;

	public static float AL_EAXREVERB_MIN_DENSITY = 0.0f,
	...
	public static int AL_EAXREVERB_MIN_DECAY_HFLIMIT = 0x0,
	...
	public static float AL_CHORUS_MIN_RATE = 0.0f,
	...
	public static int AL_FLANGER_WAVEFORM_SINUSOID = 0x0,
	...
	public static float AL_FLANGER_MIN_RATE = 0.0f,
	...
	public static int AL_FREQUENCY_SHIFTER_MIN_LEFT_DIRECTION = 0x0,
	...
	public static float AL_VOCAL_MORPHER_MIN_RATE = 0.0f,
						AL_VOCAL_MORPHER_MAX_RATE = 10.0f,
						AL_VOCAL_MORPHER_DEFAULT_RATE = 1.41f;

	public static int AL_PITCH_SHIFTER_MIN_COARSE_TUNE = 0xFFFFFFF4,
	...
	public static float AL_RING_MODULATOR_MIN_FREQUENCY = 0.0f,
	...
	public static int AL_RING_MODULATOR_SINUSOID = 0x0,
	...
	public static float AL_AUTOWAH_MIN_ATTACK_TIME = 1.0E-4f,
	...
	public static int AL_COMPRESSOR_MIN_ONOFF = 0x0,
					  AL_COMPRESSOR_MAX_ONOFF = 0x1,
					  AL_COMPRESSOR_DEFAULT_ONOFF = 0x1;

	public static float AL_EQUALIZER_MIN_LOW_GAIN = 0.126f,
	...
	public static void alGenAuxiliaryEffectSlots(IntBuffer auxiliaryeffectslots) {
		EXTEfx.alGenAuxiliaryEffectSlots(auxiliaryeffectslots);
	}
	...
	public static void alDeleteAuxiliaryEffectSlots(IntBuffer auxiliaryeffectslots) {
		EXTEfx.alDeleteAuxiliaryEffectSlots(auxiliaryeffectslots);
	}
	...
	public static void alGetEffect(int effect, int param, IntBuffer intdata) {
		EXTEfx.alGetEffectiv(effect, param, intdata);
	}
	...
	public static void alGetEffect(int effect, int param, FloatBuffer floatdata) {
		EXTEfx.alGetEffectfv(effect, param, floatdata);
	}
	...
	public static void alGetFilter(int filter, int param, IntBuffer intdata) {
		EXTEfx.alGetFilteriv(filter, param, intdata);
	}
	...
	public static void alGetFilter(int filter, int param, FloatBuffer floatdata) {
		EXTEfx.alGetFilterfv(filter, param, floatdata);
	}
}
